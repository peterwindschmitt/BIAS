...
public class BIASModifiedOtpPageController 
{
	...
	@FXML private void handleExecuteButton(ActionEvent event) 
	{
		...
		if (!BIASGeneralConfigController.getUseSerialTimeAsFileName())
		{
			...
			if ((prefs.get("mo_lastDirectorySavedTo", null) != null) && (BIASGeneralConfigController.getUseLastDirectory()))
			{
				Path path = Paths.get(prefs.get("mo_lastDirectorySavedTo", null));
			...
			if (file != null) 
			{
				try 
				{
					...
					if (BIASProcessPermissions.verifiedWriteUserPrefsToRegistry.toLowerCase().equals("true"))
						prefs.put("mo_lastDirectorySavedTo", file.getParent());
				} 
				catch (Exception e) 
				{
