...
public class BIASRadixxResSsimConversionController 
{
	...
	private void chooseFile()
	{
		...
		if (file != null) 
		{
			...
			// Write message
			clearMessage();
			message = "BIAS Radixx Res SSIM Conversion Module - "+BIASLaunch.getSoftwareVersion()+"\n";
	...
	private void runTask() throws Exception
	{
		...
		if (ssimToExcel)
		{
			...
			if (!WriteRadixxToExcelFiles2.getErrorFound())
			{
