...
public class BIASPreprocessLinesForMaintenanceWindowAndGradeXingSpeedAnalysis 
{
	...
	public BIASPreprocessLinesForMaintenanceWindowAndGradeXingSpeedAnalysis(File lineFile) 
	{
		...
		try 
		{
			...
			while (scanner.hasNextLine()) 
			{
				...
				if (lineFromFile.contains("Line #"))
				{
					...
					if (lineName.startsWith("MOW"))
					{
						availableLinesStartingWithMOW.add(lineName);
					}
				}
			}
		}
		...
		sortedLinesStartingWithMOW = new ArrayList<>(availableLinesStartingWithMOW);
		Collections.sort(sortedLinesStartingWithMOW, new sortItems());
	}
	...
	public List<String> returnAllAvailableLines()
	{
		return sortedLines;
	}
	
	public List<String> returnAvailableLinesStartingWithMOW()
	{
		return sortedLinesStartingWithMOW;
	}
}