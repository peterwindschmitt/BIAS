...
public class ReadRadixxResSSIMIATAFileForConversionToExcel 
{
	...
	private static RadixxScheduleInputIATA schedule = new RadixxScheduleInputIATA();
	
	private static RadixxFlightLegInputIATA lastFlightLeg;

	public ReadRadixxResSSIMIATAFileForConversionToExcel(String file) 
	{
	...
	public static RadixxScheduleInputIATA getSchedule()
	{
		return schedule;
	}
