...
public class WriteModifiedOtpFiles1 
{
	...
	public WriteModifiedOtpFiles1 (String textArea, String fileAsString)
	{
		if (BIASModifiedOtpConfigPageController.getPerformLatenessToExternalScheduleAnalysis())
		{
			...
			// Write Set A
			modifiedOtpSheet = workbook.createSheet("Modfied OTP (.TRAIN vs Config)");
			...
			cell.setCellValue("Modified OTP Analysis (.TRAIN vs Config) for "+fileAsString.replace(".OPTION", ""));
