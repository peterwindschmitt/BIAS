...
public class WriteJuaComplianceFiles5 extends WriteJuaComplianceFiles4
{
	...
	public WriteJuaComplianceFiles5(String textArea, String fullyQualifiedPath) 
	{
				...
				&& (BIASJuaComplianceConfigController.getCheckPermitsSumOfTrackMiles()))
		{
			...
			cell.setCellValue("JUA Compliance:  Slow Order Comparison Between "+thisCase + " .PERMIT File and "+lastAcceptedPermitFileName2+" .PERMIT File");
