...
public class WriteJuaComplianceFiles1
{
	...
	protected static String thisCase = BIASJuaComplianceController.getCaseNameAsString();
	...
	public WriteJuaComplianceFiles1(String textArea, String fullyQualifiedPath)
	{
		if (BIASJuaComplianceConfigController.getCheckEnabledCountOfTrains())
		{
			...
			cell.setCellValue("JUA Compliance:  Train Count Assessment for "+thisCase + " Case");
			...
			cell = row.createCell(2);
			cell.setCellStyle(style5);
			cell.setCellValue((ConvertNumberDatatypes.round(averageDailyCountOfBrightlineOperatedTrains, 1)) + " average daily");
			...
			cell = row.createCell(2);
			cell.setCellStyle(style5);
			cell.setCellValue((ConvertNumberDatatypes.round(averageDailyCountOfFecOperatedTrains, 1)) + " average daily");
			...
			cell = row.createCell(2);
			cell.setCellStyle(style5);
			cell.setCellValue((ConvertNumberDatatypes.round(averageDailyCountOfTriRailOperatedTrains, 1)) + " average daily");
