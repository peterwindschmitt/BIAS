...
public class WriteTTestFiles5
{
	...
	private static XSSFSheet trueDm100tmTTestSheet; 

	private static IndexedColors[] tTestColors = new IndexedColors[8];
	
	public WriteTTestFiles5(String textAreaContents, HashSet<ResultFromTTest> byTypeTTestResults, HashSet<ResultFromTTest> byGroupTTestResults)
	{
		...
		resultsMessage = WriteTTestFiles4.getResultsMessageWrite4();
		workbook = WriteTTestFiles4.getWorkbook4();

		if (TTestValidateTTest.getGenerateTrueDelayMinutesPer100TrainMiles())
		{
	...
	public void writeFiles5()
	{
		...
		{
			trueDm100tmTTestSheet = workbook.createSheet("True DM100TM");
			trueDm100tmTTestSheet.setDisplayGridlines(false);
			Row row;
			Cell cell; 

			// Write header here
			// First row of sheet header
			row = trueDm100tmTTestSheet.createRow(rowNumber);
			...
			if (byGroupTTestResults.size() > 0)
			{
				...
				if (BIASTtestConfigPageController.getShowSlightAndEqualTstatColumns())
				{
					trueDm100tmTTestSheet.addMergedRegion(new CellRangeAddress(rowNumber, rowNumber, 0, 10));
				}
				else
				{
					trueDm100tmTTestSheet.addMergedRegion(new CellRangeAddress(rowNumber, rowNumber, 0, 8));
				}
				
				cell = row.createCell(0);
				cell.setCellStyle(style9);
				cell.setCellValue("True Delay Minutes per 100 Train Miles - Group Tests");
				...
				setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, cell.getColumnIndex(), cell.getColumnIndex()), trueDm100tmTTestSheet);
				...
				cell.setCellValue("True DM100TM Mean Diff");
				setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, cell.getColumnIndex(), cell.getColumnIndex()), trueDm100tmTTestSheet);
				...
				cell = row.createCell(4);
				cell.setCellStyle(style10);
				cell.setCellValue("True DM100TM");
				setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, cell.getColumnIndex(), cell.getColumnIndex()), trueDm100tmTTestSheet);
				...
				{
					if ((sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesA() != null)  && (sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesB() != null))
					{
						resultsSetSize++;
						rowNumber++;
						row = trueDm100tmTTestSheet.createRow(rowNumber);
						...
						cell.setCellValue(sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesB() - sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesA());
						setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, cell.getColumnIndex(), cell.getColumnIndex()), trueDm100tmTTestSheet);

						cell = row.createCell(3);
						cell.setCellStyle(style5);
						if (Double.isInfinite(sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesTValue()))
						{
							cell.setCellValue("infinity");
						}
						else if (Double.isNaN(sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesTValue()))
						{
							cell.setCellValue(0.00);
						}
						else if (sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesB() > sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesA())
						{
							cell.setCellValue(sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesTValue());
						}
						else
						{
							cell.setCellValue(-1 * sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesTValue());
						}
						setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, cell.getColumnIndex(), cell.getColumnIndex()), trueDm100tmTTestSheet);

						cell = row.createCell(4);
						cell.setCellStyle(style11);
						cell.setCellValue(sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesA());
						setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, cell.getColumnIndex(), cell.getColumnIndex()), trueDm100tmTTestSheet);
						...
						cell.setCellStyle(style11);
						cell.setCellValue(sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesB());
						setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, cell.getColumnIndex(), cell.getColumnIndex()), trueDm100tmTTestSheet);

						// Put borders around all of the significant, slight and equal cells
						setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, 5, 5), trueDm100tmTTestSheet);
						setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, 6, 6), trueDm100tmTTestSheet);
						setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, 7, 7), trueDm100tmTTestSheet);
						if (BIASTtestConfigPageController.getShowSlightAndEqualTstatColumns())
						{
							setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, 8, 8), trueDm100tmTTestSheet);
							setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, 9, 9), trueDm100tmTTestSheet);
						}
						
						if (BIASTtestConfigPageController.getShowSlightAndEqualTstatColumns())
						{
							// Color appropriate significance column (5 through 9)
							if (sortedGroupFiles.get(i).getMeanDelayMinutesPer100TrainMilesMeanDiff() == 0)
							{
								// Is equal
								cell = row.createCell(7);
								cell.setCellStyle(style14);
								cell.setCellValue("");
								setRegionBorderThick(new CellRangeAddress(rowNumber, rowNumber, cell.getColumnIndex(), cell.getColumnIndex()), trueDm100tmTTestSheet);
							}
							else if (sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesSignificant())
							{
								if (sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesA() < sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesB())
								{
						...
						else
						{
							...
							if (sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesSignificant())
							{
								if ((sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesA()) < (sortedGroupFiles.get(i).getDelayMinutesPer100TrainMilesB()))
								{
									// Is significant and A < B
				...
				// Set thick borders
				setRegionBorderThick(new CellRangeAddress(lastClusterRowStart, rowNumber, 4, 4), trueDm100tmTTestSheet);
				if (BIASTtestConfigPageController.getShowSlightAndEqualTstatColumns())
				{
					setRegionBorderThick(new CellRangeAddress(lastClusterRowStart, rowNumber, 10, 10), trueDm100tmTTestSheet);
				}
				else
				{
					setRegionBorderThick(new CellRangeAddress(lastClusterRowStart, rowNumber, 8, 8), trueDm100tmTTestSheet);
				}
				rowNumber++;
			...
			if (byTypeTTestResults.size() > 0)
			{
				...
				cell = row.createCell(0);
				cell.setCellStyle(style9);
				cell.setCellValue("True Delay Minutes per 100 Train Miles - Type Tests");
				...
				{
					if ((sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesA() != null)  && (sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesB() != null))
					{
						resultsSetSize++;
						rowNumber++;
						row = trueDm100tmTTestSheet.createRow(rowNumber);
						...
						cell = row.createCell(2);
						cell.setCellStyle(style5);
						if (sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesB() > sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesA())
						{
							cell.setCellValue(sortedTypeFiles.get(i).getMeanDelayMinutesPer100TrainMilesMeanDiff());
						}
						else
						{
							cell.setCellValue(-1 * sortedTypeFiles.get(i).getMeanDelayMinutesPer100TrainMilesMeanDiff());
						}
						setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, cell.getColumnIndex(), cell.getColumnIndex()), trueDm100tmTTestSheet);

						cell = row.createCell(3);
						cell.setCellStyle(style5);
						if (Double.isInfinite(sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesTValue()))
						{
							cell.setCellValue("infinity");
						}
						else if (Double.isNaN(sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesTValue()))
						{
							cell.setCellValue(0.00);
						}
						else if (sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesB() > sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesA())
						{
							cell.setCellValue(sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesTValue());
						}
						else
						{
							cell.setCellValue(-1 * sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesTValue());
						}
						setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, cell.getColumnIndex(), cell.getColumnIndex()), trueDm100tmTTestSheet);

						cell = row.createCell(4);
						cell.setCellStyle(style11);
						cell.setCellValue(sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesA());
						setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, cell.getColumnIndex(), cell.getColumnIndex()), trueDm100tmTTestSheet);
						...
						cell.setCellStyle(style11);
						cell.setCellValue(sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesB());
						setRegionBorderThin(new CellRangeAddress(rowNumber, rowNumber, cell.getColumnIndex(), cell.getColumnIndex()), trueDm100tmTTestSheet);
						...
						{	
							// Color appropriate significance column (5 through 9)
							if (sortedTypeFiles.get(i).getMeanDelayMinutesPer100TrainMilesMeanDiff() == 0)
							{
								// Is equal
								cell = row.createCell(7);
								cell.setCellStyle(style14);
							...
							else if (sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesSignificant())
							{
								if (sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesA() < sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesB())
								{
									// Is significant and A > B
									cell = row.createCell(5);
									cell.setCellStyle(style12);
						...
						{
							// Color appropriate significance column (5 through 7)
							if (sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesSignificant())
							{
								if ((sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesA()) < (sortedTypeFiles.get(i).getDelayMinutesPer100TrainMilesB()))
								{
									// Is significant and A < B
		...
		for(int i = 0; i < 11; i++) 
		{
			if (i <= 4)
			{
				trueDm100tmTTestSheet.autoSizeColumn(i);
				int currentWidth = trueDm100tmTTestSheet.getColumnWidth(i);
				currentWidth += 360;
				trueDm100tmTTestSheet.setColumnWidth(i, currentWidth);
			}
			else if ((i == 10) && (BIASTtestConfigPageController.getShowSlightAndEqualTstatColumns()))
			{
				trueDm100tmTTestSheet.autoSizeColumn(i);
				int currentWidth = Math.max(trueDm100tmTTestSheet.getColumnWidth(4), trueDm100tmTTestSheet.getColumnWidth(10));
				currentWidth += 360;
				trueDm100tmTTestSheet.setColumnWidth(4, currentWidth);
				trueDm100tmTTestSheet.setColumnWidth(10, currentWidth);
			}
			else if ((i == 8) && (!BIASTtestConfigPageController.getShowSlightAndEqualTstatColumns()))
			{
				trueDm100tmTTestSheet.autoSizeColumn(i);
				int currentWidth = Math.max(trueDm100tmTTestSheet.getColumnWidth(4), trueDm100tmTTestSheet.getColumnWidth(8));
				currentWidth += 360;
				trueDm100tmTTestSheet.setColumnWidth(4, currentWidth);
				trueDm100tmTTestSheet.setColumnWidth(8, currentWidth);
			}
			else
			{
				trueDm100tmTTestSheet.setColumnWidth(i, 4100);
			}
		}
		resultsMessage += "\nWrote "+resultsSetSize+ " true delay minutes per 100 train miles t-test results";
	}
	...
	public static XSSFWorkbook getWorkbook5()
	{
		return workbook;
	}

	public static String getResultsMessageWrite5()
	{
		return resultsMessage;
	}

	public static int getResultsSetSize5()
	{
